...
| File | Current | Notes |
|------|---------|-------|
| `hero.png` | Live screenshot of popwiz.ai landing (1600×900 PNG, ~728 KB) | Update by re-running a 1600×900 capture of the production site. If size matters, run through `pngquant`. |
